      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center">
            ...
            <span className="text-white font-semibold text-lg ml-2 hidden sm:block">
            ...
            {user ? (
              <>
                <button
                  ...
                  className="w-10 h-10 bg-teal-500 rounded-full flex items-center justify-center hover:bg-teal-400 transition-colors"
                >
                ...
                {showDropdown && (
                  <div className="absolute right-0 mt-2 w-48 bg-gray-900 rounded-lg shadow-xl border border-gray-800 py-1">
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 w-full px-4 py-2 text-gray-300 hover:bg-gray-800 hover:text-white transition-colors"
                    >
